...
_G.sys_Menus.TABBAR = { title = _TM"Tabbar Context Menu",
    ...
    {'Open File Folder', action=function() shell.exec(Iif(not _G.iuprops['settings.tabmenu.opencmd'], 'explorer "'..props['FileDir']..'"', (_G.iuprops['settings.tabmenu.opencmd'] or ''):gsub('%%P', props['FileDir']))) end},
...
_G.sys_Menus.MainWindowMenu = {title = _TM"Main Window Menu",
	...
	{'Search', {
		...
		{'Prevous Find Result',  action = function() CORE.FindResult(-1) end, key = 'Ctrl+Shift+R', },
		{'Next Change',  visible="(_G.iuprops['changes.mark.line'] or 0) == 1", action = function() CORE.CoToChange(1) end, key = 'Ctrl+W',},
		{'Prevous Change',  visible="(_G.iuprops['changes.mark.line'] or 0) == 1", action = function() CORE.CoToChange(-1) end, key = 'Ctrl+Shift+W', },
