...
_G.sys_Menus.MainWindowMenu = {
	...
	{'Search', ru = 'Поиск',{
		...
		{'Search', ru = 'Поиск', plane = 1,{
			...
			{'Find Next Word/Selection', ru = 'Слово/выделение - в диалог поиска', action = CORE.Find_FindInDialog, key='Ctrl+F3',},
			{'Next Word/Selection', ru = 'Следующее слово/выделение', action = function() CORE.FindNextWrd(2) end, key='Alt+F3',},
	...
	{'Options', ru = 'Настройки',{
		...
		{'Hidden Plugins', ru = 'Загрузка фоновых плагинов...', action = "dofile(props['SciteDefaultHome']..'\\\\tools\\\\HiddenPlugins.lua')('Hidden')"},
		{'Commands Plugins', ru = 'Загрузка команд...', action = "dofile(props['SciteDefaultHome']..'\\\\tools\\\\HiddenPlugins.lua')('Commands')"},
		{'s3', separator = 1},
