...
_G.sys_Menus.MainWindowMenu = {title = "Главное меню программы",
	...
	{'View', ru = 'Вид',{
		...
		{'&Margin', ru = 'Показывать закладки', action = IDM_SELMARGIN, check = "scite.SendEditor(SCI_GETMARGINWIDTHN,1)>0"},
	...
	{'Options', ru = 'Настройки',{
		...
		{'Save Configuration...', ru = 'Сохранить конфигурацию как...', action = iup.SaveIuprops},
		{'Save Current Configuration', ru = 'Сохранить текущую конфигурацию: '..(iuprops['current.config.restore'] or ''):gsub('^.-([^\\]-)%.[^\\.]+$', '%1'), action = iup.SaveCurIuprops, visible = "iuprops['current.config.restore']~=nil"},
		{'s5', separator = 1},
