...
_G.sys_Menus.TABBAR = { title = "Контекстное меню закладок",
    ...
    {'s1', separator = 1},
	{'Move to another window', ru = 'Переместить на другое окно', action = IDM_CHANGETAB, },
	{'Clone to another window', ru = 'Клонировать в другом окне', action = IDM_CLONETAB, },
...
_G.sys_Menus.MainWindowMenu = {title = "Главное меню программы",
	...
	{'Options', ru = 'Настройки',{
		...
		{'Load Configuration...', ru = 'Загрузить конфигурацию...', action = iup.LoadIuprops, image = 'folder_open_document_µ'},
