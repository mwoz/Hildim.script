...
_G.sys_Menus.MainWindowMenu = {title = "Главное меню программы",
	...
	{'Search', ru = 'Поиск',{
		...
		{'Search', ru = 'Поиск', plane = 1,{
			...
			{'Clear LiveSearch Markers', ru = 'Очистить маркеры живого поиска', action = function() CORE.ClearLiveFindMrk() end, key = 'Ctrl+Alt+Shift+F',},
		}},
        {'s11', separator = 1},
	...
	{'Options', ru = 'Настройки',{
        ...
        {'Color Scheme', ru = 'Цветовые схемы', visible = RunSettings,{
            ...
            {'Atrium', ru = 'Атриум', action = function() DoSett('Colors_Atrium') end, },
            {'Dark Blue', ru = 'Темно-синяя', action = function() DoSett('Colors_Darkblue') end, },
            {'Work', ru = 'Work', action = function() DoSett('Colors_Work') end, },
            {'s5', separator = 1},
            {'Save Scheme', ru = 'Сохранить схему...', action = function() DoSett('CreateColorSettings') end, },
            {'Load Scheme', ru = 'Загрузить схему...', action = function() DoSett('ApplyColorsSettings') end, },
        },},
