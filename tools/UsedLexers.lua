--[[ƒиалог редактировани€ списка €зыков]]
local function Show()
    ...
    btn_ok.action = function()
        ...
        for i = 0, maxL  do
            if iup.GetAttributeId2(list_lex, 'TOGGLEVALUE', i, 1) == '1' then
                ...
                strLng = strLng..list_lex:getcell(i,2)..'Х'..list_lex:getcell(i,5)..'Х'..list_lex:getcell(i,3)..'Х'..list_lex:getcell(i,4)
    ...
    dlg = iup.scitedialog{vbox; title="—писок используемых €зыков",defaultenter="LEX_BTN_OK",defaultesc="LEX_BTN_ESC",tabsize=editor.TabWidth,
