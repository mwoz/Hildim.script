...
local function Run()
    local translit = {
        ['a'] = "а", ['b'] = "б", ['v'] = "в", ['w'] = "в", ['g'] = "г", ['d'] = "д", ['e'] ="е", ['jo']="Є",
        ['yo'] = "Є", ['zh'] = "ж", ['z'] = "з", ['i'] = "и", ['j'] = "й", ['jj'] = "й", ['k'] ="к", ['l'] ="л",
        ['m'] = "м", ['n'] = "н", ['o'] = "о", ['p'] = "п", ['r'] = "р", ['s'] = "с", ['t'] ="т", ['u'] ="у",
        ['f'] = "ф", ['h'] = "х", ['x'] = "х", ['c'] = "ц", ['ch'] = "ч", ['sh'] = "ш", ['shh']="щ",['\'']="ь",
    ['y'] = "ы", ['\"'] = "ъ", ['~'] = "ъ",  ['je'] = "э", ['ju'] = "ю", ['yu'] = "ю", ['ja']="€", ['ya']="€"}
...
return {
    title = 'Translit',
    run = Run,
    description = [[ћодуль предназначен дл€ транслитерации
английских букв в русские]]
}
