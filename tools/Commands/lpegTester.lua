...
return {
    title = 'Lpeg Tester',
    run = Run,
    description = [[Тестирование регулярных выражений в формате lpeg.
Введенный в диалоговом окне lua-фрагмент должен в return возвращать lpeg-шаблон,
который будет применен к тексту в открытом окне. Результат выводится в консоль]]
}
