...
_G.sys_Menus.MainWindowMenu = {
    ...
    {'Edit', ru='Правка',{
        ...
        {'Select t&o Brace', ru = 'Выделить до парний сокбки', key = 'Ctrl+Shift+E', action = IDM_SELECTTOBRACE},
        ...
        {'Block Co&mment or Uncomment', ru = 'Закоментировать и раскоментировать текст', key = 'Ctrl+Q', action = IDM_BLOCK_COMMENT},
