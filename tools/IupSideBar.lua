...
local win_parent --ñîçäàåì îñíîâíîå îêíî
local tbs
local vbox
...
local function InitSideBar()
    ...
    -- SideBar_obj.win = false --åñëè óñòàíîâèòü true - ïàíåëü áóäåò ïîêàçàíà îòäåëüíûì îêíîì
    SideBar_Plugins = {}
...
AddEventHandler("OnSendEditor", function(id_msg, wp, lp)
    if id_msg == SCN_NOTYFY_ONPOST then
        if wp == POST_CONTINUESTARTUP then  --Ïîêàç îòäåëüíûì îêíîì ðàçâÿçûâàåì ÷åðåç ïîñò, èíà÷å ïëîõî èêîíêè ïîêàçûâàåò
