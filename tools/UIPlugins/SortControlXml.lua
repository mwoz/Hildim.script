...
local function Init()
    ...
    local function NormaliseKeyWordsCase()
    ...
    menuhandler:InsertItem('MainWindowMenu', 'Tools¦Utils¦xxx',
        {'4->3 Tab size Indent', ru = 'Отступ 4->3', action = function() For2ThreeTabIndent() end,}
    )
end
return {
    title = 'Упорядочивание тегов',
    hidden = Init,
    description = [[Упорядочивание тегов, перевод ключевых слов в стандартный кейс - FormEnjine']]
}
