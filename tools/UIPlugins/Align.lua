local function Init()
    ...
    {'Alignment by symbol...', action = do_Align, key = 'Alt+Shift+A', active = 'editor:LineFromPosition(editor.SelectionStart) ~= editor:LineFromPosition(editor.SelectionEnd)', image = 'edit_column_µ'}, nil, _T)
